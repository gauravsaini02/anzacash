...
router.get('/vendors/current-vendors', authenticateToken, requireAdminRole, adminController.getActiveVendorsCount);
router.get('/users/statistics', authenticateToken, requireAdminRole, adminController.getUserStatistics);
