...
export class OrderController {
  ...
  async createOrder(req: Request, res: Response): Promise<void> {
    try {
      ...
      const newOrder = await prisma.tbl_sh_orders.create({
        data: {
  ...
  async getCustomerOrders(req: Request, res: Response): Promise<void> {
    try {
      ...
      const total = await prisma.tbl_sh_orders.count({
        where: whereClause
      });
    ...
    try {
      ...
      const ordersWithDetails = await Promise.all(
        orders.map(async (order) => {
          ...
          const customer = await prisma.nasso_users.findUnique({
  ...
  async updateOrderStatus(req: Request, res: Response): Promise<void> {
    try {
      ...
      const order = await prisma.tbl_sh_orders.findFirst({
        where: {
      ...
      if (status) updateData.oda_status = status;
      if (deliveryStatus) updateData.o_delivery = deliveryStatus;

      const updatedOrder = await prisma.tbl_sh_orders.update({
  ...
  async getOrderDetails(req: Request, res: Response): Promise<void> {
    try {
      ...
      const otherParty = await prisma.nasso_users.findUnique({
